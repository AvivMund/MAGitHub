...
<!DOCTYPE html>
<html>
    <%@page import="magit.webapp.utils.*" %>
    <%@ page import="magit.webapp.constants.Constants" %>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>MAGitHub</title>
...
<!--        and\or any other scripts you might need to operate the JSP file behind the scene once it arrives to the client-->
    ...
    <body>
        <div class="container">
            ...
            <a href="../userpage.html">Click here to enter your page</a>
            <br/>
